...
var geo:THREE.PlaneBufferGeometry;
var length = 1;
var width = 1;

function createGeometry():THREE.PlaneBufferGeometry{
...
function createShaderMaterial(texture:any):THREE.ShaderMaterial {
...
window.onload = function () {
    ...
    camera.position.z = 1;
    var renderer:THREE.WebGLRenderer = createRenderer();
    document.body.appendChild(renderer.domElement);

    var textureA:THREE.WebGLRenderTarget = createRenderTarget();
    var textureB:THREE.WebGLRenderTarget = createRenderTarget();
